...
export const chatQuestions = [
  ...
  {
    id: 2,
    question: `Направление деятельности вашей компании?`,
    tags: [{ title: 'промышленность' }, { title: 'e-com' }, { title: 'инженерные технологии' }]
  },
  {
    id: 3,
    ...
    tags: [
      ...
      { title: 'Повысить лояльность сотрудников' },
      { title: 'Увеличить количество клиентов' }
    ]
  },
  {
    id: 4,
    question: `Желаемые сроки работ?`,
    tags: [{ title: '1-3 месяца' }, { title: '3-6 месяцев' }, { title: 'до 1 года' }]
  },
  {
    id: 5,
    question: `Напишите название компании, ваше имя, номер телефона и электронную почту. Мы перезвоним вам в ближайшее время. Обращаю ваше внимание, что отправляя номер вы соглашаетесь 
    `,
    link: {
      text: `с политикой конфиденциальности`,
      url: 'http://localhost:3000/politic'
  ...
  {
    id: 6,
    question: `Информация принята. Мы вам перезвоним или напишем на указанный номер. Спасибо за обращение, хорошего дня!
    `
  }
];
